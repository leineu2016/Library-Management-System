...
/**
 * Jersey REST client generated for REST resource:LibraryGroupsFacadeREST
 * [entity.librarygroups]<br>
 * USAGE:
 * <pre>
 *        LibraryGroupsRESTClient client = new LibraryGroupsRESTClient();
 ...
 *
 */
public class LibraryGroupsRESTClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/LIBRARY-JEE-RS/webresources";

    public LibraryGroupsRESTClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entity.librarygroups");
    }

    public String findByUserName(String userName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("byUserName/{0}", new Object[]{userName}));
        return resource.request(javax.ws.rs.core.MediaType.TEXT_PLAIN).header("Authorization", LibrarySessionRestLogin.getInstance().getRestAuth()).get(String.class);
    }
